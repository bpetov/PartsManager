...
#os.chdir('/Users/boyanpetov/Documents/MyFirstProject')


FORM_CLASS,_ = loadUiType(path.join(path.dirname('__file__'), "partsinventorymanager.ui"))
...
class Main(QMainWindow, FORM_CLASS):
    ...
    def GET_DATA(self):
        ...
        #display reference number and type number in Statistics tab
        ...
        #display 4 results: Min, MaX Nbr of holes in addition to their respective references names
    ...
    def DELETE(self):
        ...
        command = '''DELETE FROM parts WHERE ID=? '''
